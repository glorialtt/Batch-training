...
Here we build a neural network with one hidden layer.
    ...
    output layer: 7 neurons, representing the type of Steel Plate Faults
"""
...
#optimizer = torch.optim.Rprop(net.parameters(), lr=learning_rate) momentum=0.9  0.5(71-74) 0.7(72-79) 0.9(70-72) 0.6(7-78)
...
create a confusion matrix, indicating for every Steel Plate Faults (rows)
